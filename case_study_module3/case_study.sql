...
INSERT INTO `case_study_furama`.`loai_khach` (`ten_loai_khach`) VALUES 
('Diamond'),('Platinium'),('Gold'),('Silver'),('Member');

INSERT INTO `case_study_furama`.`khach_hang` (`ma_loai_khach`, `ho_ten`, `ngay_sinh`, `gioi_tinh`, `so_cmnd`, `so_dien_thoai`, `email`, `dia_chi`) VALUES 
...
INSERT INTO `case_study_furama`.`kieu_thue` (`ten_kieu_thue`) VALUES 
('Year'),('Month'),('Day'),('Hour');

INSERT INTO `case_study_furama`.`loai_dich_vu` (`ten_loai_dich_vu`) VALUES 
('Villa'),('House'),('Room');
...
INSERT INTO `case_study_furama`.`dich_vu_di_kem` (`ten_dich_vu_di_kem`, `gia`, `don_vi`, `trang_thai`) VALUES 
...
INSERT INTO `case_study_furama`.`hop_dong` (`ngay_lam_hop_dong`, `ngay_ket_thuc`, `tien_dat_coc`, `ma_nhan_vien`, `ma_khach_hang`, `ma_dich_vu`) VALUES 
...
INSERT INTO `case_study_furama`.`hop_dong_chi_tiet` (`ma_hop_dong`, `ma_dich_vu_di_kem`, `so_luong`) VALUES 
(2, 4, 5),
(2, 5, 8),
(2, 6, 15),
(3, 1, 1),
