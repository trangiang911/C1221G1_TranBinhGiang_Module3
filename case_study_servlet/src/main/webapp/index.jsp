...
<div style="height: 100%">
    <div class="row">
        <div class="col-sm-8"><a href="#"><img
                src="https://cdn.nhanlucnganhluat.vn/uploads/images/051D288B/logo/2018-12/Logo-FURAMA-RESORT.jpg" alt=""></a></div>
    ...
    <div class="row" >
        <div class="col-sm-2">
            <div class="list-group" style="width: 100%;border-right: 1px solid black">
