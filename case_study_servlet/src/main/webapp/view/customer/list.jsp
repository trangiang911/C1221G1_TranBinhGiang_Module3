...
<div style="height: 100%">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <button type="submit"><a href="/customer?action=create">Thêm mới</a></button>
            <hr>
            ...
            <table border="1" cellpadding="5" id="Mytable" class="table table-striped table-bordered"
                ...
                <c:forEach var="x" items="${list}" varStatus="index">
                    <tr>
                        ...
                        <td>${x.getHoTen()}</td>
                        <td>${x.getNgaySinh()}</td>
                        <td><c:if test="${x.getGioiTinh() == 0}">
                            Nữ
                        </c:if>
                            <c:if test="${x.getGioiTinh() == 1}">
                                Nam
                            </c:if></td>
                        <td>${x.getSoCMND()}</td>
                        ...
                        <td>${x.getEmail()}</td>
                        <td>${x.getDiaChi()}</td>
                        <td><a href="/customer?action=edit&id=${x.getMaKhachHang()}">edit</a></td>
                        <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModalCenter" onclick="deleteCustomer(${x.getMaKhachHang()})">
                                delete
                            </button>
