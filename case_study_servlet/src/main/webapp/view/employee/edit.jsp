...
<form method="post">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Lương</td>
                <td><input type="text" name="luong" value="<fmt:formatNumber>${employee.getLuong()}</fmt:formatNumber>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="dia_chi" value="${employee.getDiaChi()}"></td>
            </tr>
            <tr>
