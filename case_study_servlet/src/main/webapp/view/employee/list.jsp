...
<div style="height: 100%">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <button type="submit"><a href="/employee?action=create">Thêm mới</a></button>
            <hr>
            ...
            <table border="1" cellpadding="5" id="Mytable" class="table table-striped table-bordered"
                ...
                <c:forEach var="x" items="${list}" varStatus="index">
                    <tr>
                        ...
                        <td>${x.getDiaChi()}</td>
                        <td>
                        <c:forEach var="y" items="${position_list}">
                            <c:if test="${x.getMaViTri() eq y.getMaViTri()}">
                                ${y.getTenViTri()}
                            </c:if>
                        </c:forEach>
                        </td>
                        <td>
                            <c:forEach var="z" items="${education_list}">
                                <c:if test="${z.getMaTringDo() eq x.getMaTrinhDo()}">
                                    ${z.getTenTrinhDo()}
                                </c:if>
                            </c:forEach>
                        </td>
                        <td>
                        <c:forEach var="a" items="${division_list}">
                            <c:if test="${a.getMaBoPhan() eq x.getMaBoPhan()}">
                                ${a.getTenBoPhan()}
                            </c:if>
                        </c:forEach>
                        </td>
